...
# Anthony Edward Stark(Tony Stark--Iron Man Sketch using python
# we are going to use python turtle to sketch the diagram 
# Lets Start
...
class techghost:
    def __init__ (self):
        # I will provide the these axis points in description...
